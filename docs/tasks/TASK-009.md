# TASK-009 — Stage: devplan (task_list.md & tasks/*.md with XML sections)
**Date:** 2025-09-15

## ContextEngineering
```xml
<task>Stage: devplan (task_list.md & tasks/*.md with XML sections)</task>
<context>
...
<implement>
Generate task_list.md and write tasks/<id>.md using XML sections; include per-task context summaries.
</implement>
<subtask>
- [ ] Stage: devplan (task_list.md & tasks/*.md with XML sections): design
- [ ] Stage: devplan (task_list.md & tasks/*.md with XML sections): implement
- [ ] Stage: devplan (task_list.md & tasks/*.md with XML sections): unit/integration tests
- [ ] Stage: devplan (task_list.md & tasks/*.md with XML sections): docs & snapshots
</subtask>
<dod>
