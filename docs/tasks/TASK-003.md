# TASK-003 — Stage: intake (timeline prompt, requirements.md)
**Date:** 2025-09-15

## ContextEngineering
```xml
<task>Stage: intake (timeline prompt, requirements.md)</task>
<context>
...
<implement>
Read input/*.md sort by YYYY-MM-DD, compile timeline section, build PO/PM prompt, call /agents/run, write requirements.md with headers.
</implement>
<subtask>
- [ ] Stage: intake (timeline prompt, requirements.md): design
- [ ] Stage: intake (timeline prompt, requirements.md): implement
- [ ] Stage: intake (timeline prompt, requirements.md): unit/integration tests
- [ ] Stage: intake (timeline prompt, requirements.md): docs & snapshots
</subtask>
<dod>
