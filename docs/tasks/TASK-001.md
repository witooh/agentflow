# TASK-001 — Config loader & validator (JSON schema)
**Date:** 2025-09-15

## ContextEngineering
```xml
<task>Config loader & validator (JSON schema)</task>
<context>
...
<implement>
Implement config package: load JSON, validate required fields, defaulting, env override, redact secrets in logs.
</implement>
<subtask>
- [x] Config loader & validator (JSON schema): design
- [x] Config loader & validator (JSON schema): implement
- [x] Config loader & validator (JSON schema): unit/integration tests
- [x] Config loader & validator (JSON schema): docs & snapshots
</subtask>
<dod>
