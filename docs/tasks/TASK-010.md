# TASK-010 — CI: tests, snapshot assertions, coverage report
**Date:** 2025-09-15

## ContextEngineering
```xml
<task>CI: tests, snapshot assertions, coverage report</task>
<context>
...
<implement>
GH Actions: go test, coverage, snapshot compare, artifact upload.
</implement>
<subtask>
- [ ] CI: tests, snapshot assertions, coverage report: design
- [ ] CI: tests, snapshot assertions, coverage report: implement
- [ ] CI: tests, snapshot assertions, coverage report: unit/integration tests
- [ ] CI: tests, snapshot assertions, coverage report: docs & snapshots
</subtask>
<dod>
